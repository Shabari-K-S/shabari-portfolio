...
<div class="wrap">
  <div class="icon">
    ...
    <div class="second">
      <div class="square-1"><a href="#"><h1><i class="bi bi-linkedin"></i></h1></a></div>
      <div class="square-2"><a href="#"><h1><i class="bi bi-instagram"></i></h1></a></div>
      <div class="square-3"><a href="#"><h1><i class="bi bi-box"></i></h1></a></div>
      <div class="square-4"><a href="#"><h1><i class="bi bi-github"></i></h1></a></div>
    </div>
  </div>
</div>
"""
